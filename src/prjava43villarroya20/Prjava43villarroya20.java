package prjava43villarroya20;
import java.awt.*; // using AWT containers and components
import java.awt.event.*; // using AWT events and listener interfaces
import java.net.*;
public class Prjava43villarroya20 extends Frame
...
setTitle("prjava43villarroya20"); // "this" Frame sets title
setSize(250, 100); // "this" Frame sets initial size
setVisible(true); // "this" Frame shows
}
/** The entry main() method */
public static void main(String[] args) {
new Prjava43villarroya20(); // Let the construct do the job
}
/** ActionEvent handler */
@Override
